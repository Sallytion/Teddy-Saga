...
class LinkedInJobsScraper:
    ...
    def check_authentication(self) -> bool:
        ...
        self.logger.error("No LinkedIn authentication found. Please set LINKEDIN_COOKIE environment variable.")
        return False
    ...
    def run_scraper(self):
        ...
        scraper = LinkedinScraper(
            ...
            page_load_timeout=scraper_settings['page_load_timeout']
        )
